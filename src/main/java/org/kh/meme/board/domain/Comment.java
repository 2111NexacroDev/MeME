...
public class Comment {
	...
	public Comment(int commentNo, int boardNo, int commentParentsno, String memberId, String memberNickname,
			String commentContents, Date commentDate, Date commentRedate, String commentStatus) {
		super();
	...
	public String toString() {
		return "Comment [commentNo=" + commentNo + ", boardNo=" + boardNo + ", commentParentsno=" + commentParentsno
				+ ", memberId=" + memberId + ", memberNickname=" + memberNickname + ", commentContents="
				+ commentContents + ", commentDate=" + commentDate + ", commentRedate=" + commentRedate
